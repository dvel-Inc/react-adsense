...
var Google = function (_React$Component) {
  ...
  _createClass(Google, [{
    ...
    value: function checkIfAdIsEmpty(node) {
      var adNode = node || document.getElementById(this.uniqueId);
      console.log('now check if there is something in the iframe');
      var iframeOutter = adNode.getElementsByTagName('iframe')[0];
    ...
    value: function startObserver() {
      ...
      var adNode = document.getElementById(this.uniqueId);
          ...
          for (var _iterator = mutationsList[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
            ...
            if (mutation.type === 'attributes') {
              ...
              if (mutation.attributeName === 'data-adsbygoogle-status') {
                ...
                _this2.checkIfAdIsEmpty(adNode);
              }
            }
          }
        } catch (err) {
